...
public class TodoAdapter extends ArrayAdapter<TodoItem> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        AppCompatImageButton deleteButton = convertView.findViewById(R.id.deleteButton);
        AppCompatImageButton confirmButton = convertView.findViewById(R.id.confirmButton);
